...
class FbGraph extends DynamicDataPlugin
{
	...
	var $lang = array(
		'de' => array(
			'plugin.fbgraph.legend.results' => 'Ergebniswerte',
			'plugin.fbgraph.legend.reference' => 'Vergleichswerte',
		),
		'en' => array(
			'plugin.fbgraph.legend.results' => 'Result values',
...
*/
	...
	function setupGraph()
	{
        ...
        $grapher[] = array('init', array('x' => 600, 'y' => (count($values['user'])*55)+120)    );

        // Initialize plotarea
        $grapher[] = array('addPlotArea', array('ymin' => 0, 'ymax' => 110, 'ticks' => array(0, 10, 20, 100),
			'pad_x' => true, 'legend' => 30, 'bordercolor' => '#81a0c9')
		);
		
		// Make descriptions a bit prettier
		$grapher[] = array('setFont', array('size' => 10, 'type' => PORTAL.'external/verdana.ttf'));
       ...
       if (isset($values['reference'])) 
			$grapher[] = array('addDatasets', array('sets' => 2));
		else 
		...
		if (isset($values['reference'])) 
			$grapher[] = array('addPlot', array('type' => 'bar', 'line_style' => 'dashed', 'line_color' => '#aaaaaa', 'display' => 'stacked', 'datasets' => array(0), 'area' => 0, 'title' => T('plugin.fbgraph.legend.reference')));
		...
		$grapher[] = array('setMarker', array('plot' => 1, 'style' => 'value', 'bordercolor' => '#000080', 'bgcolor' => 'white', 'color' => '#000080'));
		// Set marker style for reference plot
		if (isset($values['reference'])) 
			$grapher[] = array('setMarker', array('plot' => 0, 'style' => 'value2', 'bordercolor' => '#999999', 'bgcolor' => '#ffffff', 'color' => '#999999'));
